...
import UseFavoriteQuiz from "../../hooks/quiz/UseAddFavoriteQuiz";
import UseDeleteFavoriteQuizId from "../../hooks/quiz/UseDeleteFavoriteQuizId";
import UseCheckQuizIsLikedByUserId from "../../hooks/quiz/UseCheckQuizIsLikedByUserId";
function QuizCardAttemp({ quiz , setIsOpen}) {
...
Total score(s) {quiz.totalScore}  </p>
</div>
...
<div className="flex gap-4 bg-red items-center justify-center absolute bottom-0 right-0 mr-8 mb-6">
<img onClick={() => handleSetQuizOption(quiz.quizId.toString())} className="h-[35px] w-[35px] cursor-pointer" src="/circle-info-solid-2.svg" alt="quiz Info" />

<a href={`/take-quiz/${quiz.quizId}`}><img className="h-[35px] w-[35px] cursor-pointer" src="/circle-play-solid-icon.svg" alt="Do the quiz" /></a>
</div>
